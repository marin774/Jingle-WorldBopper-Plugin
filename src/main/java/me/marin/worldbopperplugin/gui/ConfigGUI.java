...
public class ConfigGUI extends JPanel {
    ...
    public ConfigGUI() {
        ...
        keepWorldsWithNetherCheckBox.addActionListener(e -> {
            ...
            WorldBopperSettings.save();
            Jingle.log(Level.INFO, "(WorldBopper) " + (settings.keepNetherWorlds ? "WorldBopper will now be keeping worlds with nether enters." : "WorldBopper will now be clearing worlds with nether enters."));
        });
